...
Runs an MLDS experiment with the method of quadruples
...
python mlds_experiment_quadruples.py design_GA_quadruples_0.csv
...
class Experiment(window.Window):
    ...
    def load_images(self):
        ...
        self.image4 = pyglet.image.load(self.design['S4'][self.currenttrial])
    ...
    def savetrial(self, resp, resptime):
        ...
        row = [resp, self.design['S1'][self.currenttrial], self.design['S2'][self.currenttrial],
               self.design['S3'][self.currenttrial], self.design['S4'][self.currenttrial]]
...
if __name__ == "__main__":
    ...
    # it no argument passed, uses default design file    
        ...
        designfile = 'designs/Gabriel/Gabriel_quadruples_0.csv'
    
    # for fullscreen, use fullscreen=True and give your correct screen resolution in width= and height=
    win = Experiment(caption="MLDS experiment with quadruples", 
